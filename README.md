...
extracts the requested category fields through two independent paths, compares
the results, and surfaces mismatches for human review.
...
6. Show verified results or human-review fields in the dashboard. A reviewer
...
The handoff validation snapshot is five real BuilderLab PDFs: 3 verified, 2
human review, 0 failed, with 31 automated tests passing.
